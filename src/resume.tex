...
\experience{Data Science Intern}{Safety Products, Johnson Controls}{Jun 2022}{Present }{
    \achievement{
     ...
     Initiated a project to correlate alternative GeoSpatial data points (such as 'Property Crime Index', Demographics, etc.) with traditional data points to form a ZIP code based area heat maps to identify growth opportunities. 
