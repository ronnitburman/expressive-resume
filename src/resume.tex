...
\objective{
\\A machine learning engineering graduate with hands on work experience as a Data Scientist - seeking opportunities to be able to apply Machine Learning methods and develop algorithms to solve real world industrial problems.}
...
\experience{Data Science Intern}{Tyco Security Products}{Jun 2022}{Dec 2022}{
    \achievement{
...
\experience{Teaching Assistant}{University of Waterloo}{Jan 2022}{Dec 2022}{
    \achievement{
    ...
    \achievement{
       ...
       SYDE-192L (Spring 22) \& BME-341L (Winter 22) - Helped undergrads understand, develop and implement Digital Logic Systems
...
\experience{American Sign Language Recogition}{\href{https://github.com/ronnitburman/American_Sign_Language_Detection_MNIST}{\underline{Github Link}}}{Jan 2022}{Jul 2022}{
    \achievement{
...
\experience{GeoSpatial Data Analytics \& Data Visualization}{Personal Project}{Oct 2022}{Jun 2022}{
    \achievement{
        ...
        Cleaned raw data to extract zip-code and city data. Increased capacity from 100 requests per minute to unlimited requests by developing a package to bypass GIS API call). Visualized data for GeoSpatial analytics and understanding using ESRI modules in Power BI. 
